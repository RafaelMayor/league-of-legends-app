...
async function displayChampions() {
    ...
    const champions = await (0, _apiJs.getChampions)();
    if (!champions) {
            ...
            <div class="card">
                ...
                <div class="blurb">
                    ...
                    <div class="stats hidden">
                        ...
                        <p>Vida: ${stats.hp} - Regeneraci\xf3n de vida: ${stats.hpregen}</p>
                    </div>
                </div>
            </div>
        `;
    ...
    readMoreButtons.forEach((button)=>{
        button.addEventListener("click", function() {
            ...
            if (!statsElement.classList.contains("hidden")) this.innerText = "Ver menos";
            else this.innerText = "Ver m\xe1s";
        });
    });
}
displayChampions();

},{"./api.js":"9u7qN"}],"9u7qN":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getChampions", ()=>getChampions);
...
},{}]},["aP7aF","8lRBv"], "8lRBv", "parcelRequire4953")
